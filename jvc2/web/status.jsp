...
<%@ page import="java.sql.*" %>
 ...
 <body>
 	...
 	<center>
 	<label><h3>Status Form<h3></label>
 	</center>
            <div class="row">
                <div class="col-sm-8">
                    <form method="get" action="addservlet">
 			<div class="form-group">
                            <label for="email"><b>Status:</b></label> <input type="text"
 					class="form-control" id="email" placeholder="Enter status"
 					name="num1">
 			</div>
                ...
                <table class="table table-dark table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a role="button" href="update.jsp?Id=<%=Id%>" class="btn btn-primary " >Edit</a></td>
                      <td><a role="button" href="delete.jsp?Id=<%=Id%>" class="btn btn-primary">Delete</a></td>
                    </tr>
                    <%
                        }
                    %>
